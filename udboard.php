                  ...
                  <div class="d-flex align-items row">
                    <div class="col-sm-7">
                      <div class="card-body">
                        ...
                        <a class="btn btn-primary" href="userlist.php?id=<?= $fetch_profile['id']; ?>">Go to My Profile</a>
                      </div>
                    </div>
              ...
              <div class="col-lg-4 col-md-4 order-1">
                <div class="row">
                  <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card card-border-shadow-primary h-100">
                      <div class="card-body">
                        <span class="d-block fw-medium mb-1">Number of <a href="benlist.php"><span>Beneficiaries</span></a>:</span>
                  ...
                  <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card card-border-shadow-success h-100">
                      <div class="card-body">
                        <span class="d-block fw-medium mb-1">Number of <a href="scholist.php"><span> Active Scholars</span></a>:</span>
                  ...
                  <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card card-border-shadow-warning h-100">
                      <div class="card-body">
                        <span class="d-block fw-medium mb-1">Medical Assistance <a href="medass.php"><span>Recipients</span></a>:</span>
                  ...
                  <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card card-border-shadow-info h-100">
                      <div class="card-body">
                        <span class="d-block fw-medium mb-1">Secret Santa <a href="secsandon.php"><span> Active Donors</span></a>:</span>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <ul class="timeline">
                      ...
                      <a href="cal.php" class="btn btn-primary">Go to Calendar</a>
                    </ul>
                    <!-- /Activity Timeline -->
                  </div>
                </div>
