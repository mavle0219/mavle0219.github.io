...
<head>
    ...
    <title>Medical Mission Add Recipients</title>
...
<body>
    ...
    if (isset($_GET['mm_id'])) {
        ...
        $select_mm = $conn->prepare("SELECT * FROM `medmiss` WHERE mm_id = :mm_id");
        $select_mm->bindParam(':mm_id', $mm_id);
        if ($select_mm->execute()) {
            $mm = $select_mm->fetch(PDO::FETCH_ASSOC);
            if ($mm) {
    ...
    ?>
                        ...
                        <div class="layout-page">
                                        ...
                                        <form method="POST" action="">
                                            <div class="nav-item d-flex align-items-center">
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <a href="amedmissre.php" type="button" class="btn btn-label-info">Back</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div class="content-wrapper">
                                <div class="container-xxl flex-grow-1 container-p-y">
                                    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Programs / Medical Mission / </span> Add Recipients</h4>
                                    <div class="card mb-4">
                                                ...
                                                <div class="row gy-4 gy-sm-1">
                                                    <div class="col-sm-6 col-lg-3">
                                                        <div class="d-flex justify-content-between align-items-start card-widget-1 border-end pb-3 pb-sm-0">
                                                            <div>
                                                                <h3 class="mb-2"><?php echo $mm['mm_event']; ?></h3>
                                                                <p class="mb-0"><?php echo $mm['mm_eventname']; ?></p>
                                                            </div>
                                                    ...
                                                    <div class="col-sm-6 col-lg-3">
                                                        <div class="d-flex justify-content-between align-items-start card-widget-1 border-end pb-3 pb-sm-0">
                                                            <div>
                                                                <h3 class="mb-2"><?php $startDateTime = new DateTime($mm['mm_start']);
                                                                                    $endDateTime = new DateTime($mm['mm_end']);

                                                                                    // Format and display the hours and minutes
                                                                                    echo $startDateTime->format('H:i') . ' - ' . $endDateTime->format('H:i'); ?></h3>
                                                                <p class="mb-0">Event Schedule</p>
                                                            </div>
                                                            <div class="avatar me-sm-4">
                                                    ...
                                                    <div class="col-sm-6 col-lg-3">
                                                        <div class="d-flex justify-content-between align-items-start card-widget-2 border-end pb-3 pb-sm-0">
                                                            <div>
                                                                <h3 class="mb-2"><?php $mm_event = $mm['mm_event'];
                                                                                    $numben = $conn->query("SELECT count(*) FROM medmissre WHERE mm_event = '$mm_event'")->fetchColumn();
                                                                                    echo $numben;
                                                                                    ?></h3>
                                                                <p class="mb-0">Total Registered Patients</p>
                                                            </div>
                                    ...
                                    <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                        <button type="button" class="btn btn-label-success" onclick="addBeneficiaries('<?php echo $mm['mm_event']; ?>' , '<?php echo $mm['mm_eventname']; ?>')"><i class='bx bx-plus'>&nbsp</i> Add Beneficiaries
                                        </button>
                                    ...
                                    <div class="card">
                                        ...
                                        $mm_event = $mm['mm_event'];
                                        $mm_eventname = $mm['mm_eventname'];
                                        include "ammrlist.php";  // Include the script
                                        ?>
                                    </div>
                                </div>
                            </div>
                ...
                <script>
                    function addBeneficiaries(mm_event, mm_eventname) {
                        $.ajax({
                            url: 'ammraddall.php',
                            type: 'POST',
                            data: {
                                mm_event: mm_event,
                                mm_eventname: mm_eventname
                            }, // Pass mm_event and mm_eventname as parameters
                            success: function(response) {
                                ...
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Success!',
                                    text: '120 beneficiaries have been added successfully.',
                            ...
                            error: function(xhr, status, error) {
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Error!',
                                    text: 'Error adding beneficiaries.',
                                });
                            }
                        });
                    }
