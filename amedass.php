...
<head>
  ...
  <title>Medical Assistance List</title>
      ...
      <div class="layout-page">
              ...
              <form method="POST" action="">
                <div class="nav-item d-flex align-items-center">
                  ...
                  <div class="btn-group" role="group">
                    ...
                    <a href="amedass.php" type="button" class="btn btn-label-info">Clear</a>
                  </div>
                </div>
              </form>
            </div>
        ...
        <div class="content-wrapper">
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><span class="text-muted fw-light">Medical Assistance /</span> Medical Assistance Recipients</h4>
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between">
                      <div class="content-left">
                        <span>Medical Assistance Recipients</span>
                        <div class="d-flex align-items-end mt-2">
                          <h4 class="mb-0 me-2"><?php $numbef = $conn->query("SELECT COUNT(*) FROM `beneficiary` WHERE ben_ma = 'Yes'")->fetchColumn();
                                                echo $numbef; ?></h4>
                        </div>
                      </div>
                      <div class="avatar">
