...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
  ...
  $dob = $_POST['modalEditUserDob'];
  $gender = $_POST['modalEditUserGender'];
  $phoneNumber = $_POST['modalEditUserPhone'];
  $email = $_POST['modalEditUserEmail'];
  $school = $_POST['modalEditUserSchool'];
  $course = $_POST['modalEditUserCourse'];
  $year = $_POST['modalEditUserYear'];

  $age = calculateAge($dob);

  $updateQuery = $conn->prepare("UPDATE scholar SET sch_name=?, sch_address=?, sch_dob=?, sch_gender=?, sch_phone=?, sch_email=?, sch_school=? , sch_course=?, sch_year=?, sch_age=? WHERE sch_id=?");
  $updateQuery->execute([$fullName, $address, $dob, $gender, $phoneNumber, $email, $school, $course, $year, $age, $id]);

  $auditlogin = $conn->prepare("INSERT INTO `audit`(role, username, action) VALUES(?,?,?)");
  $auditlogin->execute(["admin", $fetch_profile['username'], "update scholar information"]);
  ...
  if ($updateQuery) {
    ...
    Swal.fire({
        icon: 'success',
        title: 'Success',
        text: 'Scholar Information Updated!',
            ...
            <div class="layout-page">
              ...
              <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                  <h4 class="py-3 mb-4"><span class="text-muted fw-light">Scholar /</span> Profiles</h4>
                  <div class="row">
                    <!-- User Sidebar -->
                        ...
                        <div class="card-body">
                          ...
                          <div class="info-container">
                            ...
                            <div class="d-flex justify-content-center pt-3">
                              ...
                              <a href="ascholist.php" class="btn btn-label-danger suspend-user">Back</a>
                            </div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="modal-body">
                            ...
                            <form id="editUserForm" class="row g-3" action="" method="post">
                              <div class="col-12 col-md-6">
                                ...
                                <input type="text" id="modalEditUserFullName" name="modalEditUserFullName" class="form-control" value="<?php echo $sch['sch_name']; ?>" autocomplete="off" />
                                <input type="hidden" name="id" value="<?php echo $sch['sch_id']; ?>" required>
                              </div>
                              <div class="col-12">
                                <label class="form-label" for="modalEditUserAddress">Address</label>
                                <input type="text" id="modalEditUserAddress" name="modalEditUserAddress" class="form-control" value="<?php echo $sch['sch_address']; ?>" autocomplete="off" />
                              </div>
                              <div class="col-12 col-md-6">
                                <label class="form-label" for="modalEditUserDob">Date of Birth</label>
                                <input type="date" id="modalEditUserDob" name="modalEditUserDob" class="form-control" value="<?php echo $sch['sch_dob']; ?>" autocomplete="off" />
                              </div>
                              <div class="col-12 col-md-6">
                                <label class="form-label" for="modalEditUserGender">Gender</label>
                                <select id="modalEditUserGender" name="modalEditUserGender" class="form-select" aria-label="Default select example">
                                  <option selected><?php echo $sch['sch_gender']; ?></option>
                              ...
                              <div class="col-12 col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                  <input type="text" id="modalEditUserPhone" name="modalEditUserPhone" class="form-control phone-number-mask" value="<?php echo $sch['sch_phone']; ?>" autocomplete="off" />
                                </div>
                              </div>
                              <div class="col-12 col-md-6">
                                <label class="form-label" for="modalEditUserEmail">Email</label>
                                <input type="text" id="modalEditUserEmail" name="modalEditUserEmail" class="form-control" value="<?php echo $sch['sch_email']; ?>" autocomplete="off" />
                              </div>
                              <div class="col-12 col-md-6">
                                <label class="form-label" for="modalEditUserSchool">School</label>
                                <input type="text" id="modalEditUserSchool" name="modalEditUserSchool" class="form-control" value="<?php echo $sch['sch_school']; ?>" autocomplete="off" />
                              </div>
                              <div class="col-12 col-md-6">
                                <label class="form-label" for="modalEditUserCourse">Course</label>
                                <input type="text" id="modalEditUserCourse" name="modalEditUserCourse" class="form-control" value="<?php echo $sch['sch_course']; ?>" autocomplete="off" />
                              </div>
                              <div class="col-12 col-md-6">
                                <label class="form-label" for="modalEditUserYear">Year Level</label>
                                <input type="text" id="modalEditUserYear" name="modalEditUserYear" class="form-control" value="<?php echo $sch['sch_year']; ?>" autocomplete="off" />
                              </div>
