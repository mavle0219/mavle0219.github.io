                        ...
                        <div class="layout-page">
                                        ...
                                        <form method="POST" action="">
                                            <div class="nav-item d-flex align-items-center">
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <a href="secsanre.php" type="button" class="btn btn-label-info">Back</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div class="content-wrapper">
                                <div class="container-xxl flex-grow-1 container-p-y">
                                    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Programs / Secret Santa / </span> View Recipients</h4>
                                    ...
                                    <div class="card">
                                        ...
                                        include "ssrlist.php";  // Include the script
                                        ?>
                                    </div>
                                </div>
                            </div>
