...
<head>
    ...
    <title>Medical Mission View Recipients</title>
                        ...
                        <div class="layout-page">
                                        ...
                                        <form method="POST" action="">
                                            <div class="nav-item d-flex align-items-center">
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <a href="medmissre.php" type="button" class="btn btn-label-info">Back</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div class="content-wrapper">
                                <div class="container-xxl flex-grow-1 container-p-y">
                                    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Programs / Medical Mission / </span> View Recipients</h4>
                                    ...
                                    <div class="card">
                                        <h5 class="card-header"><?php echo $mm['mm_eventname']; ?> <?php echo $mm['mm_event']; ?></h5>
                                        <?php
                                        // Set the ss_event as a PHP variable
                                        $mm_event = $mm['mm_event'];
                                        $mm_eventname = $mm['mm_eventname'];
                                        include "mmrlist.php";  // Include the script
                                        ?>
                                    </div>
                                </div>
                            </div>
