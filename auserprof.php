...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $confirmPassword = $_POST["modalEditUserPassword2"];
  ...
  if ($password !== $confirmPassword) {
    ...
    echo "<script>
        ...
        Swal.fire({
            ...
            // Add any further handling here, like clearing the password fields
        });
    });
  </script>";
  } else {
    ...
    try {
      ...
      $auditlogin->execute(["admin", $fetch_profile['username'], "update user information"]);
...
<body>
  ...
  if (isset($_GET['id'])) {
    ...
    $select_id = $conn->prepare("SELECT * FROM `users` WHERE id = :id");
    $select_id->bindParam(':id', $id);
    if ($select_id->execute()) {
      $id = $select_id->fetch(PDO::FETCH_ASSOC);
      if ($id) {
                        ...
                        <div class="card-body">
                          <div class="user-avatar-section">
                            <div class="d-flex align-items-center flex-column">
                              ...
                              <div class="user-info text-center">
                                <h4 class="mb-2"><?= $id['fullname'] ?></h4>
                                <span class="badge bg-label-secondary"><?= $id['username'] ?></span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="info-container">
                            ...
                            <div class="d-flex justify-content-center pt-3">
                              ...
                              <a href="auserlist.php" class="btn btn-label-danger suspend-user">Back</a>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="modal-body">
                          ...
                          <form id="editUserForm" class="row g-3" action="" method="post">
                            <div class="col-12 col-md-6">
                              ...
                              <input type="text" id="modalEditUserFullName" name="modalEditUserFullName" class="form-control" autocomplete="off" value="<?php echo $id['fullname'] ?>" />
                              <input type="hidden" name="id" value="<?php echo $id['id']; ?>" required>
                            </div>
                            <div class="col-12 col-md-6">
                              <label class="form-label" for="modalEditUserUsername">Username</label>
                              <input type="text" id="modalEditUserUsername" name="modalEditUserUsername" class="form-control" readonly value="<?php echo $id['username']; ?>" />
                            </div>
                            ...
                            <div class="col-12">
                              ...
                              <input type="text" id="modalEditUserAddress" name="modalEditUserAddress" class="form-control" autocomplete="off" value="<?php echo $id['address']; ?>" />
                            </div>
                            <div class="col-12 col-md-6">
                              <label class="form-label" for="modalEditUserRole">Role</label>
                              <input type="text" id="modalEditUserRole" name="modalEditUserRole" class="form-control" readonly value="<?php echo $id['role']; ?>" />
                            </div>
                            <div class="col-12 col-md-6">
                              <label class="form-label" for="modalEditUserPosition">Position</label>
                              <input type="text" id="modalEditUserPosition" name="modalEditUserPosition" class="form-control" autocomplete="off" value="<?php echo $id['position']; ?>" />
                            </div>
                            <div class="col-12 col-md-6">
                              <label class="form-label" for="modalEditUserPhone">Phone</label>
                              <input type="text" id="modalEditUserPhone" name="modalEditUserPhone" class="form-control" autocomplete="off" value="<?php echo $id['phone']; ?>" />
                            </div>
                            <div class="col-12 col-md-6">
                              <label class="form-label" for="modalEditUserEmail">Email</label>
                              <div class="input-group input-group-merge">
                                <input type="email" id="modalEditUserEmail" name="modalEditUserEmail" class="form-control phone-number-mask" autocomplete="off" value="<?php echo $id['email']; ?>" />
                              </div>
                            </div>
